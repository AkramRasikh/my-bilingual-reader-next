...
export const mockSnippetNoVocab = {
  baseLang: "Today I'll sing you aA tongue twister, okay?",
  id: 'c0f3a3ec-afc2-4b45-a7c7-354c9000fdb6',
  isPreSnippet: true,
  isContracted: true,
...
export const mockSnippetPartiallyBrokenDown = {
  baseLang: "Today I'll sing you aA tongue twister, okay?",
  id: 'c0f3a3ec-afc2-4b45-a7c7-354c9000fdb6',
  isPreSnippet: true,
  isContracted: true,
...
export const mockFetchContextChinese: FetchDataContextTypes = {
...
export const mockSelectedContentChinese = {
  id: 'mock-content-id',
